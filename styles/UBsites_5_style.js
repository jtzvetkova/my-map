var size = 0;
var placement = 'point';
function categories_UBsites_5(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'y':
                    return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 3.8500000000000005 + size, points: 4,
...
var style_UBsites_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_UBsites_5(feature, value, size, resolution, labelText,
